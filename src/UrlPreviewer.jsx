...
function UrlPreviewer() {
    ...
    return (
        <div id="preview" style={{ position:"absolute",   top:"0px", width: "100%", height: "100vh", display: "flex", justifyContent: "center", alignItems: "center", flexDirection: "column" }}>
            <div style={{ display: "flex", flexWrap: "wrap"  }} className="cellRender">
                {
                    dummy.map((item) => (
                        <div
                            key={item}
